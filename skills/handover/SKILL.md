...
Run this at the end of a session when work will continue in a fresh session. Goal: zero information loss across the session boundary. Docs and memory carry durable facts; the opening prompt carries ephemeral context.
